    ...
    public class DefCarpentry : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.ML)
            {
                ...
                index = this.AddCraft(typeof(ElvenWashBasinSouthDeed), 1044292, 1072865, 70.0, 95.0, typeof(Log), 1044041, 40, 1044351);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.ML);

                index = this.AddCraft(typeof(ElvenWashBasinEastDeed), 1044292, 1073387, 70.0, 95.0, typeof(Log), 1044041, 40, 1044351);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.ML);
            ...
            // Staves and Shields
            this.AddCraft(typeof(ShepherdsCrook), 1044295, 1023713, 78.9, 103.9, typeof(Log), 1044041, 7, 1044351);
            this.AddCraft(typeof(QuarterStaff), 1044295, 1023721, 73.6, 98.6, typeof(Log), 1044041, 6, 1044351);
            this.AddCraft(typeof(GnarledStaff), 1044295, 1025112, 78.9, 103.9, typeof(Log), 1044041, 7, 1044351);
            this.AddCraft(typeof(WoodenShield), 1044295, 1027034, 52.6, 77.6, typeof(Log), 1044041, 9, 1044351);

            if (!Core.AOS)	//Duplicate Entries to preserve ordering depending on era
            {
                index = this.AddCraft(typeof(FishingPole), 1044295, 1023519, 68.4, 93.4, typeof(Log), 1044041, 5, 1044351); //This is in the categor of Other during AoS
                this.AddSkill(index, SkillName.Tailoring, 40.0, 45.0);
                this.AddRes(index, typeof(Cloth), 1044286, 5, 1044287);
            }
            ...
            if (Core.SE)
            {
                index = this.AddCraft(typeof(Bokuto), 1044295, 1030227, 70.0, 95.0, typeof(Log), 1044041, 6, 1044351);
                this.SetNeededExpansion(index, Expansion.SE);

                index = this.AddCraft(typeof(Fukiya), 1044295, 1030229, 60.0, 85.0, typeof(Log), 1044041, 6, 1044351);
                this.SetNeededExpansion(index, Expansion.SE);

                index = this.AddCraft(typeof(Tetsubo), 1044295, 1030225, 80.0, 140.3, typeof(Log), 1044041, 10, 1044351);
                this.SetNeededExpansion(index, Expansion.SE);
            }
            ...
            if (Core.ML)
            {
                index = this.AddCraft(typeof(ElvenForgeDeed), 1044296, 1072875, 94.7, 119.7, typeof(Log), 1044041, 200, 1044351);
                this.ForceNonExceptional(index);
                this.SetNeededExpansion(index, Expansion.ML);
            }
            #endregion

            index = this.AddCraft(typeof(SmallForgeDeed), 1044296, 1044330, 73.6, 98.6, typeof(Log), 1044041, 5, 1044351);
            this.AddSkill(index, SkillName.Blacksmith, 75.0, 80.0);
            this.AddRes(index, typeof(IronIngot), 1044036, 75, 1044037);
            index = this.AddCraft(typeof(LargeForgeEastDeed), 1044296, 1044331, 78.9, 103.9, typeof(Log), 1044041, 5, 1044351);
            this.AddSkill(index, SkillName.Blacksmith, 80.0, 85.0);
            this.AddRes(index, typeof(IronIngot), 1044036, 100, 1044037);
            index = this.AddCraft(typeof(LargeForgeSouthDeed), 1044296, 1044332, 78.9, 103.9, typeof(Log), 1044041, 5, 1044351);
            this.AddSkill(index, SkillName.Blacksmith, 80.0, 85.0);
            this.AddRes(index, typeof(IronIngot), 1044036, 100, 1044037);
            index = this.AddCraft(typeof(AnvilEastDeed), 1044296, 1044333, 73.6, 98.6, typeof(Log), 1044041, 5, 1044351);
            this.AddSkill(index, SkillName.Blacksmith, 75.0, 80.0);
            this.AddRes(index, typeof(IronIngot), 1044036, 150, 1044037);
            index = this.AddCraft(typeof(AnvilSouthDeed), 1044296, 1044334, 73.6, 98.6, typeof(Log), 1044041, 5, 1044351);
            this.AddSkill(index, SkillName.Blacksmith, 75.0, 80.0);
            this.AddRes(index, typeof(IronIngot), 1044036, 150, 1044037);
            ...
            // Cooking
            index = this.AddCraft(typeof(StoneOvenEastDeed), 1044299, 1044345, 68.4, 93.4, typeof(Log), 1044041, 85, 1044351);
            this.AddSkill(index, SkillName.Tinkering, 50.0, 55.0);
            this.AddRes(index, typeof(IronIngot), 1044036, 125, 1044037);
            index = this.AddCraft(typeof(StoneOvenSouthDeed), 1044299, 1044346, 68.4, 93.4, typeof(Log), 1044041, 85, 1044351);
            this.AddSkill(index, SkillName.Tinkering, 50.0, 55.0);
            this.AddRes(index, typeof(IronIngot), 1044036, 125, 1044037);
            index = this.AddCraft(typeof(FlourMillEastDeed), 1044299, 1044347, 94.7, 119.7, typeof(Log), 1044041, 100, 1044351);
            this.AddSkill(index, SkillName.Tinkering, 50.0, 55.0);
            this.AddRes(index, typeof(IronIngot), 1044036, 50, 1044037);
            index = this.AddCraft(typeof(FlourMillSouthDeed), 1044299, 1044348, 94.7, 119.7, typeof(Log), 1044041, 100, 1044351);
            this.AddSkill(index, SkillName.Tinkering, 50.0, 55.0);
            this.AddRes(index, typeof(IronIngot), 1044036, 50, 1044037);
            this.AddCraft(typeof(WaterTroughEastDeed), 1044299, 1044349, 94.7, 119.7, typeof(Log), 1044041, 150, 1044351);
            this.AddCraft(typeof(WaterTroughSouthDeed), 1044299, 1044350, 94.7, 119.7, typeof(Log), 1044041, 150, 1044351);
            ...
            this.AddSubRes(typeof(OakLog), 1072644, 65.0, 1044041, 1072652);
            this.AddSubRes(typeof(AshLog), 1072645, 80.0, 1044041, 1072652);
            this.AddSubRes(typeof(YewLog), 1072646, 95.0, 1044041, 1072652);
            this.AddSubRes(typeof(HeartwoodLog), 1072647, 100.0, 1044041, 1072652);
            this.AddSubRes(typeof(BloodwoodLog), 1072648, 100.0, 1044041, 1072652);
            this.AddSubRes(typeof(FrostwoodLog), 1072649, 100.0, 1044041, 1072652);
        }
    }
}