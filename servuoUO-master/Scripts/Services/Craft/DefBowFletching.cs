...
namespace Server.Engines.Craft
{
    ...
    public class DefBowFletching : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            this.AddSubRes(typeof(Log), 1021848, 0.0, 1072653);
            this.AddSubRes(typeof(OakLog), 1072533, 65.0, 1072653);
            this.AddSubRes(typeof(AshLog), 1072534, 80.0, 1072653);
            this.AddSubRes(typeof(YewLog), 1072535, 95.0, 1072653);
            this.AddSubRes(typeof(HeartwoodLog), 1072536, 100.0, 1072653);
            this.AddSubRes(typeof(BloodwoodLog), 1072538, 100.0, 1072653);
            this.AddSubRes(typeof(FrostwoodLog), 1072539, 100.0, 1072653);
            #endregion
