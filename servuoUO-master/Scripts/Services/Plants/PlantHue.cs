...
namespace Server.Engines.Plants
{
    ...
    public class PlantHueInfo
    {
        ...
        {
            return IsCrossable(this.m_PlantHue);
        }

        public bool IsBright()
        {
            return IsBright(this.m_PlantHue);
        }

        public PlantHue GetNotBright()
        {
            return GetNotBright(this.m_PlantHue);
        }

        public bool IsPrimary()
        {
            return IsPrimary(this.m_PlantHue);
        }
    }
}