...
{ 
    public class SBSATinker : SBInfo 
    { 
        ...
        { 
            ...
            { 
                ...
                this.Add(new GenericBuyInfo(typeof(TinkerTools), 7, 20, 0x1EB8, 0));
                ...
                this.Add(new GenericBuyInfo(typeof(BasketWeavingBook), 10625, 20, 0xFBE, 0));
            }
        }
