...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public MythicTourmaline()
            : base(0xF2D)
        {
            this.Name = "Mythic Tourmaline";
            this.Hue = 1161;
        }

        public MythicTourmaline(Serial serial)
            : base(serial)
        {
        }
        ...
        public override bool UseGumpArt
        {
            get
            {
                return true;
    ...
    {
        [Constructable]
        public LegendaryTourmaline()
            : base(0xf26)
        {
            this.Name = "Legendary Tourmaline";
            this.Hue = 53;
        }

        public LegendaryTourmaline(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public AncientTourmaline()
            : base(0xf26)
        {
            this.Name = "Ancient Tourmaline";
            this.Hue = 56;
        }

        public AncientTourmaline(Serial serial)
            : base(serial)
        {
        }
