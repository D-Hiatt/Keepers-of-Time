...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public MythicEmerald()
            : base(0xf26)
        {
            this.Name = "Mythic Emerald";
            this.Hue = 1267;
        }

        public MythicEmerald(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public LegendaryEmerald()
            : base(0xf26)
        {
            this.Name = "Legendary Emerald";
            this.Hue = 1268;
        }

        public LegendaryEmerald(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public AncientEmerald()
            : base(0xf26)
        {
            this.Name = "Ancient Emerald";
            this.Hue = 76;
        }

        public AncientEmerald(Serial serial)
            : base(serial)
        {
        }
