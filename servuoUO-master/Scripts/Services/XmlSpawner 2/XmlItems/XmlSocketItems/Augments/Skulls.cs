...
namespace Server.Items
{
    ...
    public class MythicSkull : BaseSocketAugmentation, IMythicAugment
    {
        ...
        public MythicSkull()
            : base(0x1ae4)
        {
            this.Name = "Mythic skull";
            this.Hue = 1154;
        }

        public MythicSkull(Serial serial)
            : base(serial)
        {
        }
    ...
    public class AncientSkull : BaseSocketAugmentation, IAncientAugment
    {
        ...
        public AncientSkull(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public LegendarySkull()
            : base(0x1ae4)
        {
            this.Name = "Legendary skull";
            this.Hue = 1153;
        }

        public LegendarySkull(Serial serial)
            : base(serial)
        {
        }
