...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public MythicAmethyst()
            : base(0xf26)
        {
            this.Name = "Mythic Amethyst";
            this.Hue = 11;
        }

        public MythicAmethyst(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public LegendaryAmethyst()
            : base(0xf26)
        {
            this.Name = "Legendary Amethyst";
            this.Hue = 12;
        }

        public LegendaryAmethyst(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public AncientAmethyst()
            : base(0xf26)
        {
            this.Name = "Ancient Amethyst";
            this.Hue = 15;
        }

        public AncientAmethyst(Serial serial)
            : base(serial)
        {
        }
