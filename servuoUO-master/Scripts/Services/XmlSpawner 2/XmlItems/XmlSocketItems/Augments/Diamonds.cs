...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public MythicDiamond()
            : base(0xf26)
        {
            this.Name = "Mythic Diamond";
            this.Hue = 1153;
        }

        public MythicDiamond(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public LegendaryDiamond()
            : base(0xf26)
        {
            this.Name = "Legendary Diamond";
            this.Hue = 1150;
        }

        public LegendaryDiamond(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public AncientDiamond()
            : base(0xf26)
        {
            this.Name = "Ancient Diamond";
            this.Hue = 1151;
        }

        public AncientDiamond(Serial serial)
            : base(serial)
        {
        }
