...
namespace Server.Items
{
    ...
    public class FenCrystal : BaseSocketAugmentation
    {
        ...
        public FenCrystal()
            : base(0xF8E)
        {
            this.Name = "Fen Crystal";
            this.Hue = 8;
        }

        public FenCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class RhoCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public RhoCrystal()
            : base(0xF8E)
        {
            this.Name = "Rho Crystal";
            this.Hue = 13;
        }

        public RhoCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class RysCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public RysCrystal()
            : base(0xF8E)
        {
            this.Name = "Rys Crystal";
            this.Hue = 18;
        }

        public RysCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class WyrCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public WyrCrystal()
            : base(0xF8E)
        {
            this.Name = "Wyr Crystal";
            this.Hue = 23;
        }

        public WyrCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FreCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public FreCrystal()
            : base(0xF8E)
        {
            this.Name = "Fre Crystal";
            this.Hue = 28;
        }

        public FreCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class TorCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public TorCrystal()
            : base(0xF8E)
        {
            this.Name = "Tor Crystal";
            this.Hue = 33;
        }

        public TorCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class VelCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public VelCrystal()
            : base(0xF8E)
        {
            this.Name = "Vel Crystal";
            this.Hue = 38;
        }

        public VelCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class XenCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public XenCrystal()
            : base(0xF8E)
        {
            this.Name = "Xen Crystal";
            this.Hue = 43;
        }

        public XenCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class PolCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public PolCrystal()
            : base(0xF8E)
        {
            this.Name = "Pol Crystal";
            this.Hue = 48;
        }

        public PolCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class WolCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public WolCrystal()
            : base(0xF8E)
        {
            this.Name = "Wol Crystal";
            this.Hue = 53;
        }

        public WolCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class BalCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public BalCrystal()
            : base(0xF8E)
        {
            this.Name = "Bal Crystal";
            this.Hue = 133;
        }

        public BalCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class TalCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public TalCrystal()
            : base(0xF8E)
        {
            this.Name = "Tal Crystal";
            this.Hue = 88;
        }

        public TalCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class JalCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public JalCrystal()
            : base(0xF8E)
        {
            this.Name = "Jal Crystal";
            this.Hue = 70;
        }

        public JalCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class RalCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public RalCrystal()
            : base(0xF8E)
        {
            this.Name = "Ral Crystal";
            this.Hue = 75;
        }

        public RalCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    public class KalCrystal : BaseSocketAugmentation, ICrystalAugment
    {
        ...
        public KalCrystal(Serial serial)
            : base(serial)
        {
        }
