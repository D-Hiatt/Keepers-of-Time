...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public MythicSapphire()
            : base(0xF19)
        {
            this.Name = "Mythic Sapphire";
            this.Hue = 190;
        }

        public MythicSapphire(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public LegendarySapphire()
            : base(0xF19)
        {
            this.Name = "Legendary Sapphire";
            this.Hue = 100;
        }

        public LegendarySapphire(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public AncientSapphire()
            : base(0xF19)
        {
            this.Name = "Ancient Sapphire";
            this.Hue = 94;
        }

        public AncientSapphire(Serial serial)
            : base(serial)
        {
        }
