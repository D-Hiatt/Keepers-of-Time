...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public RadiantRhoCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Rho Crystal";
            this.Hue = 13;
        }

        public RadiantRhoCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantRysCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Rys Crystal";
            this.Hue = 18;
        }

        public RadiantRysCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantWyrCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Wyr Crystal";
            this.Hue = 23;
        }

        public RadiantWyrCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantFreCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Fre Crystal";
            this.Hue = 28;
        }

        public RadiantFreCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantTorCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Tor Crystal";
            this.Hue = 33;
        }

        public RadiantTorCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantVelCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Vel Crystal";
            this.Hue = 38;
        }

        public RadiantVelCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantXenCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Xen Crystal";
            this.Hue = 43;
        }

        public RadiantXenCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantPolCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Pol Crystal";
            this.Hue = 48;
        }

        public RadiantPolCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantWolCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Wol Crystal";
            this.Hue = 53;
        }

        public RadiantWolCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantBalCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Bal Crystal";
            this.Hue = 133;
        }

        public RadiantBalCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantTalCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Tal Crystal";
            this.Hue = 88;
        }

        public RadiantTalCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantJalCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Jal Crystal";
            this.Hue = 70;
        }

        public RadiantJalCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantRalCrystal()
            : base(0xF8E)
        {
            this.Name = "Radiant Ral Crystal";
            this.Hue = 75;
        }

        public RadiantRalCrystal(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public RadiantKalCrystal()
            : base(0xF8E)
        {
            this.Name = "Kal Crystal";
            this.Hue = 46;
        }

        public RadiantKalCrystal(Serial serial)
            : base(serial)
        {
        }
