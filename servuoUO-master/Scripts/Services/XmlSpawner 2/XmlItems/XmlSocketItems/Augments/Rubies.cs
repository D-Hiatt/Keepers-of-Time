...
namespace Server.Items
{
    public class MythicRuby : BaseSocketAugmentation, IMythicAugment
    {
        ...
        public MythicRuby()
            : base(0xF13)
        {
            this.Name = "Mythic Ruby";
            this.Hue = 32;
        }

        public MythicRuby(Serial serial)
            : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public LegendaryRuby()
            : base(0xF13)
        {
            this.Name = "Legendary Ruby";
            this.Hue = 33;
        }

        public LegendaryRuby(Serial serial)
            : base(serial)
        {
        }
    ...
    public class AncientRuby : BaseSocketAugmentation, IAncientAugment
    {
        ...
        public AncientRuby()
            : base(0xF13)
        {
            this.Name = "Ancient Ruby";
            this.Hue = 30;
        }

        public AncientRuby(Serial serial)
            : base(serial)
        {
        }
