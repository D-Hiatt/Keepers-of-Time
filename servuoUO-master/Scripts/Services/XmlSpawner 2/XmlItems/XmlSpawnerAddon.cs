    ...
    public class XmlSpawnerAddon : BaseAddon
    {
        ...
        public virtual int PartialVisibility 
        {
            get 
            {
                ...
                return (int)(100.0 * nvisible / this.Components.Count + 0.5);
            }
            set 
            {
                if (this.Components == null || this.Components.Count < 1)
                    return;

                // assign visibility to the components based upon the percentage value
                int nvisible = value * (this.Components.Count - 1) / 100;
                ...
                for (int i = 0; i < this.Components.Count; i++)
                {
                    this.Components[i].Visible = (i < nvisible);
                }
            }
        }
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            // version 1
            writer.Write(this.PartialVisibility);
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            {
                case 1:
                    this.PartialVisibility = reader.ReadInt();
                    break;
            }
        }
    }
