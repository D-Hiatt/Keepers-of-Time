...
namespace Server.Mobiles
{
    ...
    public class XmlAddGump : Gump
    {
        ...
        public XmlAddGump(Mobile from, Point3D startloc, Map startmap, bool firststart, bool extension, int gumpx, int gumpy)
            : base(gumpx,gumpy)
        {
            ...
            if (acct != null)
                this.defs = XmlSpawnerDefaults.GetDefaults(acct.ToString(), from.Name);
            ...
            if (firststart)
            {
                this.defs.StartingMap = from.Map;
                this.defs.StartingLoc = from.Location;
            }
            else
            {
                this.defs.StartingMap = startmap;
                this.defs.StartingLoc = startloc;
            }

            this.defs.IgnoreUpdate = false;
            this.defs.ShowExtension = extension;

            if (this.defs.SelectionList == null)
            {
                this.defs.SelectionList = new bool[MaxEntries];
            }
            if (this.defs.NameList == null)
                this.defs.NameList = new string[MaxEntries];

            // prepare the page

            this.AddPage(0);
            if (this.defs.ShowExtension)
            {
                this.AddBackground(0, 0, 520, 500, 5054);
                this.AddAlphaRegion(0, 0, 520, 500);
            }
            else 
            {
                this.AddBackground(0, 0, 200, 500, 5054);
                this.AddAlphaRegion(0, 0, 200, 500);
            }

            y = 3;
            yinc = 20;
            // add the min/maxdelay entries
            this.AddImageTiled(5, y, 40, 19, 0xBBC);
            this.AddTextEntry(5, y, 40, 19, 0, 100, this.defs.MinDelay.TotalMinutes.ToString());
            this.AddLabel(45, y, 0x384, "MinDelay(m)");

            this.AddImageTiled(105, y, 40, 19, 0xBBC);
            this.AddTextEntry(105, y, 40, 19, 0, 101, this.defs.MaxDelay.TotalMinutes.ToString());
            this.AddLabel(145, y, 0x384, "MaxDelay(m)");

            y += yinc;
            this.AddImageTiled(5, y, 40, 19, 0xBBC);
            this.AddTextEntry(5, y, 40, 19, 0, 107, this.defs.HomeRange.ToString());
            this.AddLabel(45, y, 0x384, "HomeRng");

            this.AddImageTiled(105, y, 40, 19, 0xBBC);
            this.AddTextEntry(105, y, 40, 19, 0, 108, this.defs.SpawnRange.ToString());
            this.AddLabel(145, y, 0x384, "SpawnRng");

            y += yinc;
            this.AddImageTiled(5, y, 40, 19, 0xBBC);
            this.AddTextEntry(5, y, 40, 19, 0, 109, this.defs.ProximityRange.ToString());
            this.AddLabel(45, y, 0x384, "ProxRng");

            this.AddImageTiled(105, y, 40, 19, 0xBBC);
            this.AddTextEntry(105, y, 40, 19, 0, 110, this.defs.Team.ToString());
            this.AddLabel(145, y, 0x384, "Team");

            y += yinc;
            this.AddImageTiled(5, y, 40, 19, 0xBBC);
            this.AddTextEntry(5, y, 40, 19, 0, 113, this.defs.KillReset.ToString());
            this.AddLabel(45, y, 0x384, "KillReset");

            this.AddImageTiled(105, y, 40, 19, 0xBBC);
            this.AddTextEntry(105, y, 40, 19, 0, 121, this.defs.TriggerProbability.ToString());
            this.AddLabel(145, y, 0x384, "TrigProb");

            y += yinc;
            this.AddImageTiled(5, y, 40, 19, 0xBBC);
            this.AddTextEntry(5, y, 40, 19, 0, 111, this.defs.Duration.TotalMinutes.ToString());
            this.AddLabel(45, y, 0x384, "Duration(m)");

            this.AddImageTiled(105, y, 40, 19, 0xBBC);
            this.AddTextEntry(105, y, 40, 19, 0, 112, this.defs.ProximitySound.ToString());
            this.AddLabel(145, y, 0x384, "ProxSnd");

            y += yinc;
            this.AddImageTiled(5, y, 40, 19, 0xBBC);
            this.AddTextEntry(5, y, 40, 19, 0, 102, this.defs.RefractMin.TotalMinutes.ToString());
            this.AddLabel(45, y, 0x384, "MinRefr(m)");

            this.AddImageTiled(105, y, 40, 19, 0xBBC);
            this.AddTextEntry(105, y, 40, 19, 0, 103, this.defs.RefractMax.TotalMinutes.ToString());
            this.AddLabel(145, y, 0x384, "MaxRefr(m)");

            y += yinc;
            this.AddImageTiled(5, y, 40, 19, 0xBBC);
            this.AddTextEntry(5, y, 40, 19, 0, 104, this.defs.TODStart.TotalHours.ToString());
            this.AddLabel(45, y, 0x384, "TODStart(h)");

            this.AddImageTiled(105, y, 40, 19, 0xBBC);
            this.AddTextEntry(105, y, 40, 19, 0, 105, this.defs.TODEnd.TotalHours.ToString());
            this.AddLabel(145, y, 0x384, "TODEnd(h)");
            
            y += yinc;
            this.AddImageTiled(5, y, 40, 19, 0xBBC);
            this.AddTextEntry(5, y, 40, 19, 0, 123, this.defs.DespawnTime.TotalHours.ToString());
            this.AddLabel(45, y, 0x384, "Despawn(h)");

            // AllowNPC
            this.AddLabel(125, y, 0x384, "AllowNPC");
            this.AddCheck(105, y, 0xD2, 0xD3, this.defs.AllowNPCTrig, 312);

            //y = 164;
            yinc = 21;
            y += yinc;
            // TOD
            if (this.defs.TODMode == XmlSpawner.TODModeType.Gametime)
                this.AddLabel(25, y, 0x384, "GameTOD");
            else if (this.defs.TODMode == XmlSpawner.TODModeType.Realtime)
                this.AddLabel(25, y, 0x384, "RealTOD");
            this.AddButton(5, y, 0xD3, 0xD3, 306, GumpButtonType.Reply, 0);

            // Sequentialspawn
            this.AddLabel(125, y, 0x384, "SeqSpawn");
            this.AddCheck(105, y, 0xD2, 0xD3, (this.defs.SequentialSpawn == 0), 307);

            y += yinc;
            // IsGroup
            this.AddLabel(25, y, 0x384, "Group");
            this.AddCheck(5, y, 0xD2, 0xD3, this.defs.Group, 304);

            // HomeRangeRelative
            this.AddLabel(125, y, 0x384, "HomeRngRel");
            this.AddCheck(105, y, 0xD2, 0xD3, this.defs.HomeRangeIsRelative, 305);

            y += yinc;
            // smart spawning
            this.AddLabel(25, y, 0x384, "SmartSpawn");
            this.AddCheck(5, y, 0xD2, 0xD3, this.defs.SmartSpawning, 310);

            // AllowGhost
            this.AddLabel(125, y, 0x384, "AllowGhost");
            this.AddCheck(105, y, 0xD2, 0xD3, this.defs.AllowGhostTrig, 309);

            y += yinc;
            // ExtTrig
            this.AddLabel(25, y, 0x384, "ExtTrig");
            this.AddCheck(5, y, 0xD2, 0xD3, this.defs.ExternalTriggering, 308);

            // SpawnOnTrig
            this.AddLabel(125, y, 0x384, "SpawnOnTrig");
            this.AddCheck(105, y, 0xD2, 0xD3, this.defs.SpawnOnTrigger, 311);

            y += yinc;
            // AutoNumber
            this.AddLabel(25, y, 0x384, "AutoNumber");
            this.AddCheck(5, y, 0xD2, 0xD3, this.defs.AutoNumber, 306);
            this.AddImageTiled(105, y, 80, 19, 0xBBC);
            this.AddTextEntry(105, y, 80, 19, 0, 125, this.defs.AutoNumberValue.ToString());

            //y = 270;
            yinc = 20;
            y += yinc;
            // Name
            this.AddImageTiled(5, y, 95, 19, 0xBBC);
            this.AddTextEntry(5, y, 85, 19, 0, 114, this.defs.SpawnerName);
            this.AddLabel(105, y, 0x384, "SpawnerName");

            y += yinc;
            // speech trigger
            this.AddLabel(105, y, 0x384, "SpeechTrigger");
            this.AddImageTiled(5, y, 95, 19, 0xBBC);
            this.AddTextEntry(5, y, 85, 19, 0, 106, this.defs.SpeechTrigger);

            y += yinc;
            // skill trigger
            this.AddLabel(105, y, 0x384, "SkillTrigger");
            this.AddImageTiled(5, y, 95, 19, 0xBBC);
            this.AddTextEntry(5, y, 85, 19, 0, 124, this.defs.SkillTrigger);

            y += yinc;
            this.AddImageTiled(5, y, 95, 19, 0xBBC);
            this.AddTextEntry(5, y, 85, 19, 0, 117, this.defs.TriggerOnCarried);
            this.AddLabel(105, y, 0x384, "TrigOnCarried");

            y += yinc;
            this.AddImageTiled(5, y, 95, 19, 0xBBC);
            this.AddTextEntry(5, y, 85, 19, 0, 118, this.defs.NoTriggerOnCarried);
            this.AddLabel(105, y, 0x384, "NoTrigOnCarried");

            y += yinc;
            this.AddImageTiled(5, y, 95, 19, 0xBBC);
            this.AddTextEntry(5, y, 85, 19, 0, 119, this.defs.ProximityMsg);
            this.AddLabel(105, y, 0x384, "ProximityMsg");

            y += yinc;
            this.AddImageTiled(5, y, 95, 19, 0xBBC);
            this.AddTextEntry(5, y, 85, 19, 0, 120, this.defs.PlayerTriggerProp);
            this.AddLabel(105, y, 0x384, "PlayerTrigProp");

            y += yinc;
            this.AddImageTiled(5, y, 95, 19, 0xBBC);
            this.AddTextEntry(5, y, 85, 19, 0, 122, this.defs.TriggerObjectProp);
            this.AddLabel(105, y, 0x384, "TrigObjectProp");

            //y = 429;
            yinc = 23;
            y += yinc;
            // add the RestoreDefs button
            this.AddButton(5, y, 0xFAE, 0xFAF, 117, GumpButtonType.Reply, 0);
            this.AddLabel(35, y, 0x384, "Restore Defs");

            // add the RestoreDefs button
            this.AddButton(125, y, 0xFAE, 0xFAF, 180, GumpButtonType.Reply, 0);
            this.AddLabel(155, y, 0x384, "Options");

            y += yinc;
            // add the SaveDefs button
            this.AddButton(5, y, 0xFAE, 0xFAF, 115, GumpButtonType.Reply, 0);
            this.AddLabel(35, y, 0x384, "Save");

            // add the LoadDefs button
            this.AddButton(65, y, 0xFAE, 0xFAF, 116, GumpButtonType.Reply, 0);
            this.AddLabel(95, y, 0x384, "Load");

            // add the DefsExt entry
            this.AddImageTiled(127, y, 68, 21, 0xBBC);
            this.AddTextEntry(129, y, 64, 21, 0, 115, this.defs.DefsExt);

            y += yinc;
            // add the Add button
            this.AddButton(5, y, 0xFAE, 0xFAF, 100, GumpButtonType.Reply, 0);
            this.AddLabel(35, y, 0x384, "Add");

            // add the Goto button
            this.AddButton(64, y, 0xFAE, 0xFAF, 1000, GumpButtonType.Reply, 0);
            this.AddLabel(94, y, 0x384, "Goto");

            // add the Delete button
            this.AddButton(125, y, 0xFAE, 0xFAF, 156, GumpButtonType.Reply, 0);
            this.AddLabel(155, y, 0x384, "Del");
            ...
            if (this.defs.ShowExtension)
            {
                this.AddButton(480, y + 5, 0x15E3, 0x15E7, 200, GumpButtonType.Reply, 0);
            }
            else 
            {
                this.AddButton(180, y + 5, 0x15E1, 0x15E5, 200, GumpButtonType.Reply, 0);
            }

            if (this.defs.ShowExtension)
            {
                this.AddLabel(300, 5, 0x384, "Spawn Entries");
                // display the clear all toggle
                this.AddButton(475, 5, 0xD2, 0xD3, 3999, GumpButtonType.Reply, 0);
                ...
                for (int i = 0; i < MaxEntries; i++)
                {
                    ...
                    this.AddImageTiled(xpos + 205, ypos, 116, 23, 0x52);

                    // has this been selected for category info specification?
                    if (i == this.defs.CategorySelectionIndex)
                    {
                        this.AddImageTiled(xpos + 206, ypos + 1, 114, 21, 0x1436);
                    }
                    else
                        this.AddImageTiled(xpos + 206, ypos + 1, 114, 21, 0xBBC);

                    bool sel = false;
                    if (this.defs.SelectionList != null && i < this.defs.SelectionList.Length)
                    {
                        sel = this.defs.SelectionList[i];
                    }
                    int texthue = 0;
                    if (sel)
                        texthue = 68;
                    string namestr = null;
                    if (this.defs.NameList != null && i < this.defs.NameList.Length)
                        namestr = this.defs.NameList[i];

                    // display the name
                    //AddLabel( 280, 22 * i + 31, texthue, namestr );

                    this.AddTextEntry(xpos + 208, ypos + 1, 110, 21, texthue, 1000 + i, namestr);
                    // display the selection button
                    this.AddButton(xpos + 320, ypos + 2, (sel ? 0xD3 : 0xD2), (sel ? 0xD2 : 0xD3), 4000 + i, GumpButtonType.Reply, 0);
                    // display the info button
                    //AddButton( xpos + 340, ypos+2, 0x5689, 0x568A, 5000+i, GumpButtonType.Reply, 0);
                    this.AddButton(xpos + 340, ypos + 2, 0x15E1, 0x15E5, 5000 + i, GumpButtonType.Reply, 0);
                }
            }
        }
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch ( info.ButtonID )
            {
                ...
                case 115: // SaveDefs
                    {
                        ...
                        this.DoSaveDefs(state.Mobile, filename);
                        break;
                    }
                case 116: // LoadDefs
                    {
                        ...
                        this.DoLoadDefs(state.Mobile, filename);
                        break;
                    }
                ...
                case 155: // Return the player to the starting loc
                    {
                        this.m_From.Location = defs.StartingLoc;
                        this.m_From.Map = defs.StartingMap;
                        break;
                    }
                ...
                case 1002:  // Show Props
                    {
                        Refresh(state.Mobile);
                        this.DoShowProps(defs.LastSpawner);
                        break;
                    }
        ...
        {
            if (this.defs.NameList == null || this.defs.NameList.Length == 0)
                return "0";
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            sb.AppendFormat("{0}", this.defs.NameList.Length);
            for (int i = 0; i < this.defs.NameList.Length; i++)
            {
                sb.AppendFormat(":{0}", this.defs.NameList[i]);
            }
            return sb.ToString();
        }
        ...
        {
            if (this.defs.SelectionList == null || this.defs.SelectionList.Length == 0)
                return "0";
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            sb.AppendFormat("{0}", this.defs.SelectionList.Length);
            for (int i = 0; i < this.defs.SelectionList.Length; i++)
            {
                sb.AppendFormat(":{0}", (this.defs.SelectionList[i] ? 1 : 0));
            }
            return sb.ToString();
        }
        ...
        private void DoSaveDefs(Mobile from, string filename)
        {
            ...
            dr["SpawnerName"] = (string)this.defs.SpawnerName;
            dr["MinDelay"] = (double)this.defs.MinDelay.TotalMinutes;
            dr["MaxDelay"] = (double)this.defs.MaxDelay.TotalMinutes;
            dr["SpawnRange"] = (int)this.defs.SpawnRange;
            dr["HomeRange"] = (int)this.defs.HomeRange;
            dr["RelativeHome"] = (bool)this.defs.HomeRangeIsRelative;
            dr["IsGroup"] = (bool)this.defs.Group;
            dr["Team"] = (int)this.defs.Team;
            dr["MinRefractory"] = (double)this.defs.RefractMin.TotalMinutes;
            dr["MaxRefractory"] = (double)this.defs.RefractMax.TotalMinutes;
            dr["TODStart"] = (double)this.defs.TODStart.TotalMinutes;
            dr["TODEnd"] = (double)this.defs.TODEnd.TotalMinutes;
            dr["TODMode"] = (XmlSpawner.TODModeType)this.defs.TODMode;
            dr["Duration"] = (double)this.defs.Duration.TotalMinutes;
            dr["DespawnTime"] = (double)this.defs.Duration.TotalHours;
            dr["ProximityRange"] = (int)this.defs.ProximityRange;
            dr["ProximityTriggerSound"] = (int)this.defs.ProximitySound;
            dr["ProximityMessage"] = (string)this.defs.ProximityMsg;
            dr["SpeechTrigger"] = (string)this.defs.SpeechTrigger;
            dr["SkillTrigger"] = (string)this.defs.SkillTrigger;
            dr["SequentialSpawn"] = (int)this.defs.SequentialSpawn;
            dr["KillReset"] = (int)this.defs.KillReset;
            dr["TrigProb"] = (double)this.defs.TriggerProbability;
            dr["AllowGhost"] = (bool)this.defs.AllowGhostTrig;
            dr["AllowNPC"] = (bool)this.defs.AllowNPCTrig;
            dr["SpawnOnTrigger"] = (bool)this.defs.SpawnOnTrigger;
            dr["SmartSpawn"] = (bool)this.defs.SmartSpawning;
            dr["ExtTrig"] = (bool)this.defs.ExternalTriggering;
            dr["TrigOnCarried"] = (string)this.defs.TriggerOnCarried;
            dr["NoTrigOnCarried"] = (string)this.defs.NoTriggerOnCarried;
            dr["PlayerTrigProp"] = (string)this.defs.PlayerTriggerProp;
            dr["TrigObjectProp"] = (string)this.defs.TriggerObjectProp;
            dr["NameList"] = this.NameListToString();
            dr["SelectionList"] = this.SelectionListToString();
            dr["AddGumpX"] = (int)this.defs.AddGumpX;
            dr["AddGumpY"] = (int)this.defs.AddGumpY;
            dr["SpawnerGumpX"] = (int)this.defs.SpawnerGumpX;
            dr["SpawnerGumpY"] = (int)this.defs.SpawnerGumpY;
            dr["FindGumpX"] = (int)this.defs.FindGumpX;
            dr["FindGumpY"] = (int)this.defs.FindGumpY;
            dr["AutoNumber"] = (bool)this.defs.AutoNumber;
            dr["AutoNumberValue"] = (int)this.defs.AutoNumberValue;
            ...
            if (System.IO.File.Exists(dirname) == true)
            {
                ...
                if (ds.Tables != null && ds.Tables.Count > 0)
                {
                    ...
                    if (ds.Tables[DefsTablePointName] != null && ds.Tables[DefsTablePointName].Rows.Count > 0)
                    {
                        ...
                        try
                        {
                            this.defs.SpawnerName = (string)dr["SpawnerName"];
                        }
                        catch
                        {
                        }

                        double mindelay = this.defs.MinDelay.TotalMinutes;
                        try
                        {
                        ...
                        this.defs.MinDelay = TimeSpan.FromMinutes(mindelay);

                        double maxdelay = this.defs.MaxDelay.TotalMinutes;
                        try
                        {
                        ...
                        this.defs.MaxDelay = TimeSpan.FromMinutes(maxdelay);

                        try
                        {
                            this.defs.SpawnRange = int.Parse((string)dr["SpawnRange"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.HomeRange = int.Parse((string)dr["HomeRange"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.HomeRangeIsRelative = bool.Parse((string)dr["RelativeHome"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.Group = bool.Parse((string)dr["IsGroup"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.Team = int.Parse((string)dr["Team"]);
                        }
                        catch
                        {
                        }

                        double minrefract = this.defs.RefractMin.TotalMinutes;
                        try
                        {
                        ...
                        this.defs.RefractMin = TimeSpan.FromMinutes(minrefract);

                        double maxrefract = this.defs.RefractMax.TotalMinutes;
                        try
                        {
                        ...
                        this.defs.RefractMax = TimeSpan.FromMinutes(maxrefract);

                        double todstart = this.defs.TODStart.TotalMinutes;
                        try
                        {
                        ...
                        this.defs.TODStart = TimeSpan.FromMinutes(todstart);
                        
                        double todend = this.defs.TODEnd.TotalMinutes;
                        try
                        {
                        ...
                        this.defs.TODEnd = TimeSpan.FromMinutes(todend);
                        ...
                        {
                            if (todmode == "Realtime")
                                this.defs.TODMode = XmlSpawner.TODModeType.Realtime;
                            else if (todmode == "Gametime")
                                this.defs.TODMode = XmlSpawner.TODModeType.Gametime;
                        }

                        double duration = this.defs.Duration.TotalMinutes;
                        try
                        {
                        ...
                        this.defs.Duration = TimeSpan.FromMinutes(duration);
                        
                        double despawnTime = this.defs.DespawnTime.TotalHours;
                        try
                        {
                        ...
                        this.defs.DespawnTime = TimeSpan.FromHours(despawnTime);

                        try
                        {
                            this.defs.ProximityRange = int.Parse((string)dr["ProximityRange"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.ProximitySound = int.Parse((string)dr["ProximityTriggerSound"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.ProximityMsg = (string)dr["ProximityMessage"];
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.SpeechTrigger = (string)dr["SpeechTrigger"];
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.SkillTrigger = (string)dr["SkillTrigger"];
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.SequentialSpawn = int.Parse((string)dr["SequentialSpawn"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.KillReset = int.Parse((string)dr["KillReset"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.TriggerProbability = double.Parse((string)dr["TrigProb"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.AllowGhostTrig = bool.Parse((string)dr["AllowGhost"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.AllowNPCTrig = bool.Parse((string)dr["AllowNPC"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.SpawnOnTrigger = bool.Parse((string)dr["SpawnOnTrigger"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.SmartSpawning = bool.Parse((string)dr["SmartSpawn"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.ExternalTriggering = bool.Parse((string)dr["ExtTrig"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.TriggerOnCarried = (string)dr["TrigOnCarried"];
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.NoTriggerOnCarried = (string)dr["NoTrigOnCarried"];
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.PlayerTriggerProp = (string)dr["PlayerTrigProp"];
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.TriggerObjectProp = (string)dr["TrigObjectProp"];
                        }
                        catch
                        {
                        }
                        ...
                        try
                        {
                            this.defs.NameList = this.StringToNameList((string)dr["NameList"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.SelectionList = this.StringToSelectionList((string)dr["SelectionList"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.AddGumpX = int.Parse((string)dr["AddGumpX"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.AddGumpY = int.Parse((string)dr["AddGumpY"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.SpawnerGumpX = int.Parse((string)dr["SpawnerGumpX"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.SpawnerGumpY = int.Parse((string)dr["SpawnerGumpY"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.FindGumpX = int.Parse((string)dr["FindGumpX"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.FindGumpY = int.Parse((string)dr["FindGumpY"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.AutoNumber = bool.Parse((string)dr["AutoNumber"]);
                        }
                        catch
                        {
                        }
                        try
                        {
                            this.defs.AutoNumberValue = int.Parse((string)dr["AutoNumberValue"]);
                        }
                        catch
                        {
                        }
        ...
        private void DoShowProps(XmlSpawner x)
        {
            ...
            if (x == null || x.Deleted || x.Map == null)
                return;
            this.m_From.SendGump(new PropertiesGump(this.m_From, x));
        }
        ...
        private class PlaceSpawnerTarget : Target
        {
                ...
                : base(30, true, TargetFlags.None)
            {
                ...
                if (acct != null)
                    this.defs = XmlSpawnerDefaults.GetDefaults(acct.ToString(), state.Mobile.Name);
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                for (int i = 0; i < MaxEntries; i++)
                {
                    if (this.defs.SelectionList != null && i < this.defs.SelectionList.Length && this.defs.SelectionList[i] &&
                        this.defs.NameList != null && i < this.defs.NameList.Length && this.defs.NameList[i] != null && this.defs.NameList[i].Length > 0)
                    {
                        maxcount++;
                    }
                }
                ...
                string sname = this.defs.SpawnerName;
                if (this.defs.AutoNumber)
                {
                    sname = String.Format("{0}#{1}", this.defs.SpawnerName, this.defs.AutoNumberValue);
                }

                XmlSpawner spawner = new XmlSpawner(SpawnId, from.Location.X, from.Location.Y, 0, 0, sname, maxcount,
                    this.defs.MinDelay, this.defs.MaxDelay, this.defs.Duration, this.defs.ProximityRange, this.defs.ProximitySound, 1,
                    this.defs.Team, this.defs.HomeRange, this.defs.HomeRangeIsRelative, new XmlSpawner.SpawnObject[0], this.defs.RefractMin, this.defs.RefractMax,
                    this.defs.TODStart, this.defs.TODEnd, null, this.defs.TriggerObjectProp, this.defs.ProximityMsg, this.defs.TriggerOnCarried, this.defs.NoTriggerOnCarried,
                    this.defs.SpeechTrigger, null, null, this.defs.PlayerTriggerProp, this.defs.TriggerProbability , null, this.defs.Group, this.defs.TODMode, this.defs.KillReset, this.defs.ExternalTriggering,
                    this.defs.SequentialSpawn, null, this.defs.AllowGhostTrig, this.defs.AllowNPCTrig, this.defs.SpawnOnTrigger, null, this.defs.DespawnTime, this.defs.SkillTrigger, this.defs.SmartSpawning, null);
                ...
                spawner.SpawnRange = this.defs.SpawnRange;
                ...
                for (int i = 0; i < MaxEntries; i++)
                {
                    if (this.defs.SelectionList != null && i < this.defs.SelectionList.Length && this.defs.SelectionList[i] &&
                        this.defs.NameList != null && i < this.defs.NameList.Length && this.defs.NameList[i] != null && this.defs.NameList[i].Length > 0)
                    {
                        spawner.AddSpawn = this.defs.NameList[i];
                    }
                }

                this.defs.LastSpawner = spawner;
           
                if (this.defs.AutoNumber)
                // bump the autonumber
                    this.defs.AutoNumberValue++;

                //from.CloseGump(typeof(XmlAddGump));
                XmlAddGump.Refresh(this.m_state.Mobile, true);
        ...
        private class XmlAddOptionsGump : Gump
        {
                ...
                : base(0, 0)
            {
                ...
                this.Dragable = true;
                this.AddPage(0);
                this.AddBackground(0, 0, 300, 130, 5054);

                this.AddLabel(20, 5, 0, String.Format("Options"));
                // add the AddGumpX/Y entries
                this.AddImageTiled(5, 30, 40, 21, 0xBBC);
                this.AddTextEntry(5, 30, 40, 21, 0, 100, defs.AddGumpX.ToString());
                this.AddLabel(45, 30, 0x384, "AddGumpX");

                this.AddImageTiled(135, 30, 40, 21, 0xBBC);
                this.AddTextEntry(135, 30, 40, 21, 0, 101, defs.AddGumpY.ToString());
                this.AddLabel(175, 30, 0x384, "AddGumpY");

                // add the SpawnerGumpX/Y entries
                this.AddImageTiled(5, 55, 40, 21, 0xBBC);
                this.AddTextEntry(5, 55, 40, 21, 0, 102, defs.SpawnerGumpX.ToString());
                this.AddLabel(45, 55, 0x384, "SpawnerGumpX");

                this.AddImageTiled(135, 55, 40, 21, 0xBBC);
                this.AddTextEntry(135, 55, 40, 21, 0, 103, defs.SpawnerGumpY.ToString());
                this.AddLabel(175, 55, 0x384, "SpawnerGumpY");

                // add the FindGumpX/Y entries
                this.AddImageTiled(5, 80, 40, 21, 0xBBC);
                this.AddTextEntry(5, 80, 40, 21, 0, 104, defs.FindGumpX.ToString());
                this.AddLabel(45, 80, 0x384, "FindGumpX");

                this.AddImageTiled(135, 80, 40, 21, 0xBBC);
                this.AddTextEntry(135, 80, 40, 21, 0, 105, defs.FindGumpY.ToString());
                this.AddLabel(175, 80, 0x384, "FindGumpY");
            }
        ...
        private class XmlAddConfirmDeleteGump : Gump
        {
                ...
                : base(0, 0)
            {
                ...
                this.AddLabel(20, 225, 33, String.Format("Delete Last Spawner?"));
                this.AddRadio(35, 255, 9721, 0x86A, false, 1); // accept/yes radio
                this.AddRadio(135, 255, 9721, 0x86A, true, 2); // decline/no radio
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                switch(info.ButtonID)
                {
                    default:
                        {
                            if (radiostate == 1 && this.LastSpawner != null && !this.LastSpawner.Deleted)
                            { // accept
                                // delete it
                                this.LastSpawner.Delete();
                            }
                            break;
                        }
                }
