    ...
    public abstract class XmlQuest
    {
        ...
        public class JournalEntry
        {
            ...
            public string EntryText
            {
                get
                {
                    return this.m_EntryText;
                }
                set
                {
                    this.m_EntryText = value;
                }
            }
        }
        ...
        public class GetCollectTarget : Target
        {
            ...
            {
                if (targeted is Item && this.m_quest != null && !this.m_quest.Deleted)
                {
                    XmlQuest.Collect(from, (Item)targeted, this.m_quest);
                    from.CloseGump(typeof(XmlQuestStatusGump));
                    from.SendGump(new XmlQuestStatusGump(this.m_quest, this.m_quest.TitleString));
                }
            }
        }
    }
