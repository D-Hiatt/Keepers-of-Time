...
namespace Server.Gumps
{
    public class LastManStandingGump : Gump
    {
            ...
            : base(20, 30)
        {
            ...
            this.AddLabel(100, 10, 0, XmlPoints.GetText(from, 200500));  // "Last Man Standing Challenge"
            ...
            if (gauntlet.Participants != null)
            {
                ...
                {
                    LastManStandingGauntlet.ChallengeEntry entry = (LastManStandingGauntlet.ChallengeEntry)this.m_WorkingList[i];
            ...
            if (from == gauntlet.Challenger && !this.m_gauntlet.GameLocked)
            {
                ...
                this.AddLabel(280, height - 35, 0, XmlPoints.GetText(from, 200529));     // "Start"
            ...
            {
                this.AddLabel(130, height - 35, 68, String.Format(XmlPoints.GetText(from, 200534), gauntlet.Winner.Name)); // "{0} is the winner!"
            }
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch ( info.ButtonID )
            {
                case 1:
                    ...
                    state.Mobile.SendGump(new LastManStandingGump(this.m_gauntlet, state.Mobile, this.viewpage));
                    break;
                case 10:
                    // Entry fee
                    int val = 0;
                ...
                case 12:
                    ...
                    foreach (LastManStandingGauntlet.ChallengeEntry entry in this.m_WorkingList)
                    {
                        if (entry != null)
                        {
                    ...
                    state.Mobile.SendGump(new LastManStandingGump(this.m_gauntlet, state.Mobile, page));
                    break;
                case 13:
                    // page down
                    // try doing the default for non-participants
                ...
                default:
                    {
                        ...
                        if (info.ButtonID >= 4000)
                        {
                            ...
                            {
                                LastManStandingGauntlet.ChallengeEntry entry = (LastManStandingGauntlet.ChallengeEntry)this.m_WorkingList[selection];
                                ...
                                if (this.m_gauntlet.Participants != null)
                                {
                                    ...
                                    foreach (LastManStandingGauntlet.ChallengeEntry masterentry in this.m_gauntlet.Participants)
                                    {
                                ...
                                if (this.m_gauntlet.Participants != null)
                                {
                                    ...
                                    if (kickentry != null)
                                    {
                                        ...
                                        if (kickentry.Participant != null)
                                        {
                                            ...
                                            kickentry.Participant.SendGump(new LastManStandingGump(this.m_gauntlet, kickentry.Participant, this.viewpage));
                                        }
                                    }
                                }
        ...
        private class MemberTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Mobile && ((Mobile)targeted).Player)
                {
                    ...
                    if (this.m_gauntlet.Participants != null)
                    {
                        foreach (LastManStandingGauntlet.ChallengeEntry entry in this.m_gauntlet.Participants)
                        {
                    ...
                    this.m_list.Add(new LastManStandingGauntlet.ChallengeEntry(pm));
