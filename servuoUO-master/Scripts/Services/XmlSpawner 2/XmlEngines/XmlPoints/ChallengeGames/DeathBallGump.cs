...
namespace Server.Gumps
{
    public class DeathBallGump : Gump
    {
        ...
        private class MemberTarget : Target
        {
            ...
            private readonly DeathBallGauntlet m_gauntlet;
            public MemberTarget(DeathBallGauntlet gauntlet, ArrayList list)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Mobile && ((Mobile)targeted).Player)
                {
                    ...
                    if (this.m_gauntlet.Participants != null)
                    {
                        foreach (DeathBallGauntlet.ChallengeEntry entry in this.m_gauntlet.Participants)
                        {
                    ...
                    this.m_list.Add(new DeathBallGauntlet.ChallengeEntry(pm));
