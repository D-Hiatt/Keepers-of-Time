...
namespace Server.Gumps
{
    public class KingOfTheHillGump : Gump
    {
        ...
        private readonly KingOfTheHillGauntlet m_gauntlet;
        private readonly ArrayList m_WorkingList;
        private readonly int viewpage;
        public KingOfTheHillGump(KingOfTheHillGauntlet gauntlet, Mobile from)
            : this(gauntlet, from, 0)
        {
        }

        public KingOfTheHillGump(KingOfTheHillGauntlet gauntlet, Mobile from, int page)
            : base(20, 30)
        {
            ...
            this.AddLabel(100, 10, 0, XmlPoints.GetText(from, 200580));  // "King of the Hill Challenge"
            ...
            if (gauntlet.Participants != null)
            {
                ...
                {
                    KingOfTheHillGauntlet.ChallengeEntry entry = (KingOfTheHillGauntlet.ChallengeEntry)this.m_WorkingList[i];
            ...
            if (from == gauntlet.Challenger && !this.m_gauntlet.GameLocked)
            {
                ...
                this.AddImageTiled(280, height - 85, 30, 19, textentrybackground);
                this.AddTextEntry(280, height - 85, 30, 25, 0, 30, this.m_gauntlet.TargetScore.ToString());
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch ( info.ButtonID )
            {
                case 1:
                    ...
                    state.Mobile.SendGump(new KingOfTheHillGump(this.m_gauntlet, state.Mobile, this.viewpage));
                    break;
                case 10:
                    // Entry fee
                    int val = 0;
                ...
                case 12:
                    ...
                    foreach (KingOfTheHillGauntlet.ChallengeEntry entry in this.m_WorkingList)
                    {
                        if (entry != null)
                        {
                    ...
                    state.Mobile.SendGump(new KingOfTheHillGump(this.m_gauntlet, state.Mobile, page));
                    break;
                case 13:
                    // page down
                    // try doing the default for non-participants
                ...
                default:
                    {
                        ...
                        if (info.ButtonID >= 4000)
                        {
                            ...
                            {
                                KingOfTheHillGauntlet.ChallengeEntry entry = (KingOfTheHillGauntlet.ChallengeEntry)this.m_WorkingList[selection];
                                ...
                                if (this.m_gauntlet.Participants != null)
                                {
                                    ...
                                    foreach (KingOfTheHillGauntlet.ChallengeEntry masterentry in this.m_gauntlet.Participants)
                                    {
                                ...
                                if (this.m_gauntlet.Participants != null)
                                {
                                    ...
                                    if (kickentry != null)
                                    {
                                        ...
                                        if (kickentry.Participant != null)
                                        {
                                            ...
                                            kickentry.Participant.SendGump(new KingOfTheHillGump(this.m_gauntlet, kickentry.Participant, this.viewpage));
                                        }
                                    }
                                }
        ...
        private class MemberTarget : Target
        {
            ...
            private readonly KingOfTheHillGauntlet m_gauntlet;
            public MemberTarget(KingOfTheHillGauntlet gauntlet, ArrayList list)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Mobile && ((Mobile)targeted).Player)
                {
                    ...
                    if (this.m_gauntlet.Participants != null)
                    {
                        foreach (KingOfTheHillGauntlet.ChallengeEntry entry in this.m_gauntlet.Participants)
                        {
                    ...
                    this.m_list.Add(new KingOfTheHillGauntlet.ChallengeEntry(pm));
