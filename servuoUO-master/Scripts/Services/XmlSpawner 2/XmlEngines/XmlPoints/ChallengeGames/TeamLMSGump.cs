...
namespace Server.Gumps
{
    public class TeamLMSGump : Gump
    {
        ...
        private readonly TeamLMSGauntlet m_gauntlet;
        private readonly ArrayList m_WorkingList;
        private readonly int viewpage;
        public TeamLMSGump(TeamLMSGauntlet gauntlet, Mobile from)
        ...
        {
            public TeamsGump(TeamLMSGauntlet gauntlet, Mobile from)
                : base(350,30)
            { 
                ...
                this.AddBackground(0, 0, 210, height, 0xDAC);
                //AddAlphaRegion( 0, 0, 340, height );

                this.AddLabel(50, 10, 0, XmlPoints.GetText(from, 200611));  // "LMS Team Status"
        ...
        private class MemberTarget : Target
        {
            ...
            private readonly TeamLMSGauntlet m_gauntlet;
            public MemberTarget(TeamLMSGauntlet gauntlet, ArrayList list)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Mobile && ((Mobile)targeted).Player)
                {
                    ...
                    if (this.m_gauntlet.Participants != null)
                    {
                        foreach (TeamLMSGauntlet.ChallengeEntry entry in this.m_gauntlet.Participants)
                        {
                    ...
                    this.m_list.Add(new TeamLMSGauntlet.ChallengeEntry(pm));
