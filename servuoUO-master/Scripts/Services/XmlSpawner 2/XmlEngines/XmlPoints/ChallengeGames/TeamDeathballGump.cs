...
namespace Server.Gumps
{
    public class TeamDeathballGump : Gump
    {
        ...
        private readonly TeamDeathballGauntlet m_gauntlet;
        private readonly ArrayList m_WorkingList;
        private readonly int viewpage;
        public TeamDeathballGump(TeamDeathballGauntlet gauntlet, Mobile from)
            : this(gauntlet, from, 0)
        {
        }

        public TeamDeathballGump(TeamDeathballGauntlet gauntlet, Mobile from, int page)
            : base(20, 30)
        {
            ...
            this.AddLabel(100, 10, 0, XmlPoints.GetText(from, 200630));   // "Team Deathball Challenge"
            ...
            if (gauntlet.Participants != null)
            {
                ...
                {
                    TeamDeathballGauntlet.ChallengeEntry entry = (TeamDeathballGauntlet.ChallengeEntry)this.m_WorkingList[i];
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            switch ( info.ButtonID )
            {
                case 1:
                    ...
                    state.Mobile.SendGump(new TeamDeathballGump(this.m_gauntlet, state.Mobile, this.viewpage));
                    break;
                case 10:
                    // Entry fee
                    int val = 0;
                ...
                case 12:
                    ...
                    state.Mobile.SendGump(new TeamDeathballGump(this.m_gauntlet, state.Mobile, page));
                    break;
                case 13:
                    // page down
                    // try doing the default for non-participants
                ...
                case 300:
                    ...
                    bool complete = true;
                    foreach (TeamDeathballGauntlet.ChallengeEntry entry in this.m_WorkingList)
                    {
                        if (entry != null)
                        {
                            Mobile m = entry.Participant;
                ...
                default:
                    {
                        ...
                        if (info.ButtonID >= 4000)
                        {
                            ...
                            {
                                TeamDeathballGauntlet.ChallengeEntry entry = (TeamDeathballGauntlet.ChallengeEntry)this.m_WorkingList[selection];
                                ...
                                if (this.m_gauntlet.Participants != null)
                                {
                                    ...
                                    foreach (TeamDeathballGauntlet.ChallengeEntry masterentry in this.m_gauntlet.Participants)
                                    {
                            ...
                            if (selection < this.m_WorkingList.Count)
                            {
                                ...
                                if (this.m_gauntlet.Participants != null)
                                {
                                    ...
                                    if (kickentry != null)
                                    {
                                        ...
                                        {
                                            kickentry.Participant.SendMessage("You have been kicked from {0}", this.m_gauntlet.ChallengeName);
                                            kickentry.Participant.SendGump(new TeamDeathballGump(this.m_gauntlet, kickentry.Participant, this.viewpage));
                                        }
                                    }
                                }
        ...
        {
            public TeamsGump(TeamDeathballGauntlet gauntlet, Mobile from)
                : base(350,30)
            { 
                ...
                this.AddLabel(60, 10, 0, XmlPoints.GetText(from, 200631));  // "Deathball Team Status"
        ...
        private class MemberTarget : Target
        {
            ...
            private readonly TeamDeathballGauntlet m_gauntlet;
            public MemberTarget(TeamDeathballGauntlet gauntlet, ArrayList list)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Mobile && ((Mobile)targeted).Player)
                {
                    ...
                    if (this.m_gauntlet.Participants != null)
                    {
                        foreach (TeamDeathballGauntlet.ChallengeEntry entry in this.m_gauntlet.Participants)
                        {
                    ...
                    this.m_list.Add(new TeamDeathballGauntlet.ChallengeEntry(pm));
