    ...
    public class SpawnerExporter
    {
        ...
        public class ExportSpawnerCommand : BaseCommand
        {
            public ExportSpawnerCommand()
            {
                ...
                this.Commands = new string[] { "ExportSpawner" };
                this.ObjectTypes = ObjectTypes.Items;
                this.Usage = "ExportSpawner <filename>";
                this.Description = "Exports all Spawner objects to the specified filename.";
            ...
            public override void ExecuteList(CommandEventArgs e, ArrayList list)
            {
                ...
                this.AddResponse(String.Format("{0} spawners exported to Saves/Spawners/{1}.", spawners.Count.ToString(), filename));
				
                this.ExportSpawners(spawners, filename);
            }
            ...
            private void ExportSpawners(ArrayList spawners, string filename)
            {
                ...
                using (StreamWriter op = new StreamWriter(filePath))
                {
                    ...
                    foreach (Spawner spawner in spawners)
                        this.ExportSpawner(spawner, xml);
