...
namespace Server.Gumps
{
    public class XmlSetGump : Gump
    {
            ...
            : base(GumpOffsetX, GumpOffsetY)
        {
            ...
            this.AddBackground(0, 0, BackWidth + xextend, BackHeight + (canNull ? (EntryHeight + OffsetSize) : 0) + (canDye ? (EntryHeight + OffsetSize) : 0) + (isBody ? (EntryHeight + OffsetSize) : 0), BackGumpID);
            this.AddImageTiled(BorderSize, BorderSize, TotalWidth + xextend - (OldStyle ? SetWidth + OffsetSize : 0), TotalHeight + (canNull ? (EntryHeight + OffsetSize) : 0) + (canDye ? (EntryHeight + OffsetSize) : 0) + (isBody ? (EntryHeight + OffsetSize) : 0), OffsetGumpID);

            int x = BorderSize + OffsetSize;
            int y = BorderSize + OffsetSize;

            this.AddImageTiled(x, y, EntryWidth + xextend, EntryHeight, EntryGumpID);
            this.AddLabelCropped(x + TextOffsetX, y, EntryWidth + xextend - TextOffsetX, EntryHeight, TextHue, prop.Name);
            ...
            this.AddImageTiled(x, y, EntryWidth + xextend, EntryHeight, EntryGumpID);
            this.AddTextEntry(x + TextOffsetX, y, EntryWidth + xextend - TextOffsetX, EntryHeight, TextHue, 0, initialText);
            x += EntryWidth + xextend + OffsetSize;
            ...
            if (canNull)
            {
                ...
                this.AddImageTiled(x, y, EntryWidth + xextend, EntryHeight, EntryGumpID);
                this.AddLabelCropped(x + TextOffsetX, y, EntryWidth + xextend - TextOffsetX, EntryHeight, TextHue, "Null");
                x += EntryWidth + xextend + OffsetSize;
            ...
            if (canDye)
            {
                ...
                this.AddImageTiled(x, y, EntryWidth + xextend, EntryHeight, EntryGumpID);
                this.AddLabelCropped(x + TextOffsetX, y, EntryWidth + xextend - TextOffsetX, EntryHeight, TextHue, "Hue Picker");
                x += EntryWidth + xextend + OffsetSize;
            ...
            if (isBody)
            {
                ...
                this.AddImageTiled(x, y, EntryWidth + xextend, EntryHeight, EntryGumpID);
                this.AddLabelCropped(x + TextOffsetX, y, EntryWidth + xextend - TextOffsetX, EntryHeight, TextHue, "Body Picker");
                x += EntryWidth + xextend + OffsetSize;
                ...
                case 1:
                    {
                        ...
                        if (text != null)
                        {
                            try
                            {
                                toSet = XmlPropertiesGump.GetObjectFromString(this.m_Property.PropertyType, text.Text);
                                shouldSet = true;
                            }
                            catch
                            {
