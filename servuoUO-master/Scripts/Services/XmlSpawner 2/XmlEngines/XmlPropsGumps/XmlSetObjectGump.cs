...
namespace Server.Gumps
{
    public class XmlSetObjectGump : Gump
    {
        ...
        public XmlSetObjectGump(PropertyInfo prop, Mobile mobile, object o, Stack stack, Type type, int page, ArrayList list)
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch ( info.ButtonID )
            {
                ...
                case 1: // Change by Target
                    {
                        this.m_Mobile.Target = new XmlSetObjectTarget(this.m_Property, this.m_Mobile, this.m_Object, this.m_Stack, this.m_Type, this.m_Page, this.m_List);
                        toSet = null;
                        shouldSet = false;
                        shouldSend = false;
                        break;
            ...
            if (shouldSend)
                this.m_Mobile.SendGump(new XmlSetObjectGump(this.m_Property, this.m_Mobile, this.m_Object, this.m_Stack, this.m_Type, this.m_Page, this.m_List));

            if (viewProps != null)
                this.m_Mobile.SendGump(new XmlPropertiesGump(this.m_Mobile, viewProps));
        }
