			...
			if ( entries.Length > 0 )
			{
				...
				if ( useMaterials && theirSkill >= 70.1 )
				{
					for ( int i = 0; i < 20; ++i )
					{
						...
						switch ( check )
						{
							case BulkMaterialType.DullCopper: skillReq = 52.0/*65.0*/; break;
							case BulkMaterialType.ShadowIron: skillReq = 56.0/*70.0*/; break;
							case BulkMaterialType.Copper: skillReq = 68.0/*75.0*/; break;
							case BulkMaterialType.Bronze: skillReq = 71.0/*80.0*/; break;
							case BulkMaterialType.Gold: skillReq = 76.0/*85.0*/; break;
							case BulkMaterialType.Agapite: skillReq = 82.0/*90.0*/; break;
							case BulkMaterialType.Verite: skillReq = 88.0/*95.0*/; break;
							case BulkMaterialType.Valorite: skillReq = 90.0/*100.0*/; break;							//case BulkMaterialType.Spined: skillReq = 65.0; break;
