...
namespace Server.Engines.BulkOrders
{
	...
	public sealed class SmithRewardCalculator : RewardCalculator
	{
		...
		private static readonly ConstructCallback SackOfResources = new ConstructCallback( CreateSackOfResources );
		...
		private static Item CreateSackOfResources( int type )
		{
			return new SackOfResources();
		}
		...
		private int ComputeType( Type type, int itemCount )
		{
			...
			if ( typeIdx > m_Types.Length-2 )//5 )
				typeIdx = m_Types.Length-2;//5;
		...
		public SmithRewardCalculator()
		{
			Groups = new RewardGroup[]
				...
				new RewardGroup( 1300, new RewardItem( 1, RunicHammer, 10 ), new RewardItem( 1, SackOfResources ) ),
				new RewardGroup( 1350, new RewardItem( 1, RunicHammer, 11 ), new RewardItem( 1, SackOfResources ) ),
	...
	public sealed class TailorRewardCalculator : RewardCalculator
	{
		...
		private static int[][][] m_OldGoldTable = m_AosGoldTable;/*new int[][][]
			{
				new int[][] // 1-part (regular)
				{
		...
		public TailorRewardCalculator()
		{
			Groups = new RewardGroup[]
				...
				new RewardGroup(  400, new RewardItem( 3, Tapestry ), new RewardItem( 2, PowerScroll, 5 ), new RewardItem( 1, SturdySewingKit ), new RewardItem( 1, ColoredScissors ) ),
				...
				new RewardGroup(  500, new RewardItem( 1, Deco, Utility.Random(4) ), new RewardItem( 1, PowerScroll, 10 ), new RewardItem( 1, MastersKnife ) ),
				new RewardGroup(  550, new RewardItem( 1, ClothingBlessDeed ), new RewardItem( 1, PowerScroll, 15 ), new RewardItem( 1, Deco, Utility.Random(4) ), new RewardItem( 1, MastersKnife ) ),
				...
				new RewardGroup(  650, new RewardItem( 1, RunicKit, 2 ), new RewardItem( 1, PowerScroll, 20 ),  new RewardItem( 1, ArmorOfCrafting, Utility.RandomMinMax(7,12) ) ),
				...
				new RewardGroup( 1100, new RewardItem( 1, RunicKit, 9 ), new RewardItem( 1, SackOfResources ) ),
				new RewardGroup( 1150, new RewardItem( 1, RunicKit, 10 ), new RewardItem( 1, SackOfResources ) ),
				};
			//daat99 OWLTR end - bod reward
		}
	}
