...
namespace Server.Engines.BulkOrders
{
	public class BOBFilterGump : Gump
	{
		...
		private static int[,] m_MaterialFilters = new int[,]
			{
				...
				{ 1044094,  2 }, // Tailoring
				{ 1044286, 17 }, //{ 1044286, 12 }, // Cloth
				{ 1062235, 18 }, //{ 1062235, 13 }, // Leather
				{ 1062236, 19 }, //{ 1062236, 14 }, // Spined
				{ 1062237, 20 },{ 1062237, 15 }, // Horned
				{ 1062238, 21 }, //{ 1062238, 16 }  // Barbed
				{       0,  0 }, // --Blank--
				{		0, 22 }, // Polar
				{		0, 23 }, // Synthetic
				{		0, 24 }, // BlazeL
		...
		public BOBFilterGump( PlayerMobile from, BulkOrderBook book ) : base( 12, 24 )
		{
			...
			AddBackground( 10, 10, /*600*/630, 439, 5054 );

			AddImageTiled( 18, 20, /*583*/613, 420, 2624 );
			AddAlphaRegion( 18, 20, /*583*/613, 420 );

			AddImage( 5, 5, 10460 );
			AddImage( /*585*/615, 5, 10460 );
			AddImage( 5, 424, 10460 );
			AddImage( /*585*/615, 424, 10460 );
