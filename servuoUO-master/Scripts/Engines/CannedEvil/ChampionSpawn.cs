...
namespace Server.Engines.CannedEvil
{
	public class ChampionSpawn : Item
	{
		...
		public void EndRestart()
		{
			if( RandomizeType )
			{
				switch( Utility.Random( 5 ) )
				{
					...
					case 5: Type = ChampionSpawnType.Crafter; break; //daat99 champ 2/6
		...
		public void Respawn()
		{
			...
			while( m_Creatures.Count < ( ( m_SPawnSzMod * ( 200 / 12 ) ) ) - ( GetSubLevel() * ( m_SPawnSzMod * ( 40 / 12 ) ) ) ) //(200 - (GetSubLevel() * 40)))
			{
				Mobile m = Spawn();
