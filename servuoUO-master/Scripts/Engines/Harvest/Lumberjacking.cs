	...
	public class Lumberjacking : HarvestSystem
	{
		...
		private Lumberjacking()
		{
			...
			if ( Core.ML )
			{
				...
				{
					new HarvestVein( 34.0/*49.0*/, 0.0, res[0], null ),	// Ordinary Logs
					new HarvestVein( 11.0/*30.0*/, 0.5, res[1], res[0] ), // Oak
					new HarvestVein( 10.0, 0.5, res[2], res[0] ), // Ash
					new HarvestVein( 09.0/*05.0*/, 0.5, res[3], res[0] ), // Yew
					new HarvestVein( 08.0/*03.0*/, 0.5, res[4], res[0] ), // Heartwood
					new HarvestVein( 07.0/*02.0*/, 0.5, res[5], res[0] ), // Bloodwood
					new HarvestVein( 06.0/*01.0*/, 0.5, res[6], res[0] ), // Frostwood
