    ...
    public class MythicCharacterToken : Item
    {
        ...
        private class MythicCharacterTokenGump : Gump
        {
            private static readonly Dictionary<int, string> _SkillMap = new Dictionary<int, string>
            {
                ...
                {1044064, "Arms Lore"}, {1044066, "Begging"}, {1044067, "Blacksmithing"}, {1044112, "Bushido"}, {1044070, "Camping"},
                ...
                {1044116, "Imbuing"}, {1044083, "Inscription"}, {1044063, "Item Identification"}, {1044084, "Lock Picking"}, {1044104, "Lumberjacking"},
