...
{
	public class BannerOfYewAddon : Item, IAddon
	{

		[Constructable]
		public BannerOfYewAddon() : base( 0x4B66 )
		{
			Movable = false;
		}

		public BannerOfYewAddon( Serial serial ) : base( serial )
		{
		}
		...
		public Item Deed
		{
			get{ return new BannerOfYewDeed(); }
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( house != null && house.IsCoOwner( from ) )
			{
				...
				{
					from.CloseGump( typeof( BannerOfYewAddonGump ) );
					from.SendGump( new BannerOfYewAddonGump( from, this ) );
				}
				else
				{
		...
		private class BannerOfYewAddonGump : Gump
		{
			private Mobile m_From;
			private BannerOfYewAddon m_Addon;
	...
	public class BannerOfYewDeed : Item
	{
		public override int LabelNumber{ get{ return 1098174; } } //Banner of Yew

		[Constructable]
		public BannerOfYewDeed() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public BannerOfYewDeed( Serial serial ) : base( serial )
		{
		}
		...
		public void Placement_OnTarget( Mobile from, object targeted, object state )
		{
			...
			if ( house != null && house.IsCoOwner( from ) )
			{
				...
				if ( northWall && westWall )
					from.SendGump( new BannerOfYewDeedGump( from, loc, this ) );
				else
		...
		private class BannerOfYewDeedGump : Gump
		{
			private Mobile m_From;
			private Point3D m_Loc;
			private BannerOfYewDeed m_Deed;

			public BannerOfYewDeedGump( Mobile from, Point3D loc, BannerOfYewDeed deed ) : base( 150, 50 )
			{
				m_From = from;
				m_Loc = loc;
				m_Deed = deed;
