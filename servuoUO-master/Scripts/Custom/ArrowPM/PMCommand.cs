...
namespace Bittiez.ArrowPM
{
    public class PMCommand
    {
        ...
        public static void Initialize()
        {
			...
			//Bittiez.Tools.Initialize ();
			Tools().ConsoleWrite(ConsoleColor.Blue, "ArrowPM Version " + Tools.Format_Version(Version));
        }
        ...
        public static void On_PM(CommandEventArgs e)
        {
            ...
            PersonalMessage PM = new PersonalMessage(Sender, MC[0], DateTime.UtcNow, Message);
