...
{
	public class GreaterPoisonElementalPotion : BasePotion
	{
		[Constructable]
		public GreaterPoisonElementalPotion() : base( 0xF0B, PotionEffect.PoisonElemental )
		{
			Weight = 1.0;
			Movable = true;
			Hue = 143;
			Name = "A Greater Poison Elemental Potion";
		}

		public GreaterPoisonElementalPotion( Serial serial ) : base( serial )
		{
		}
	  	...
	  	public override void Drink( Mobile m )
			...
			m.RevealingAction();
         	...
         	else
         	{
                ...
                public class GPThrowTarget : Target
		{
			public GPThrowTarget() : base( 12, true, TargetFlags.None )
			{
			}
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				{
					GreaterPoisonPotion poison = (GreaterPoisonPotion)targeted;
					 ...
					 if ( poison.Amount < 20 )
					{
						from.SendMessage( "That probably wouldn't be enough poison!" );
                                        ...
                                        {
                                        SpellHelper.Summon( new GreaterPoisonElemental(), from, 0x217, duration, false, false );
                                        poison.Delete();
                                        return;
                                        }
