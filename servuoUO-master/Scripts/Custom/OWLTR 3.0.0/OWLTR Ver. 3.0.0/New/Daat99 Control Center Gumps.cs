...
namespace daat99
{
	public class Daat99CustomOWLTRGump : Gump 
	{
		...
		public Daat99CustomOWLTRGump( PlayerMobile from ) : base( 100, 100 ) 
		{
			...
			AddLabel( 35, 198, 70, @"MuleForge\RunicJewls\Storage" );
			...
			///DO NOT CHANGE THESE LINES
			///DO NOT CHANGE THESE LINES
			AddHtml(260, 65, 285, 40, String.Format("<basefont color=#00ff00>I'd like to say a special Thanks for a huge assistance in testing efforts to:</font>"), false, false);
			///DO NOT CHANGE THESE LINES
			///DO NOT CHANGE THESE LINES
			...
			//crafts
			AddHtml( 260, 225, 285, 20, @"<basefont color=#ff0000>Enable\Disable each craft individually:</font>", false, false );
			//alchemy
	...
	public class OWLTRbodGump : Gump
	{
		...
		public OWLTRbodGump( PlayerMobile from ) : base(0, 0)
		{
			...
			if (from.NextSmithBulkOrder == TimeSpan.Zero)
			{
				...
				AddLabel(95, 45, 69, "Use the button to take blacksmith bod now." );
			}				
			else
				AddLabel(50, 45, 69, "Next Blacksmithy bod will be vailable in: " + s_BS );
			...
			if (from.NextTailorBulkOrder == TimeSpan.Zero)
			{
				...
				AddLabel(95, 75, 69, "Use the button to take tailoring bod now." );
			}				
			else
				AddLabel(60, 75, 69, "Next Tailoring bod will be vailable in: " + s_TL );
		}
	...
	public class MissingRecipesGump : Gump
	{
		...
		{
			Mobile from = state.Mobile;
			int count = i_Page * 30;// TODO: Unused var
			switch (info.ButtonID)
			{
