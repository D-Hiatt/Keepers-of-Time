...
{
	public class DaemonStatueN : Mobile
	{
		[Constructable]
		public DaemonStatueN()
		{
			Body = 9;
			Name = "Stone Daemon Statue";
			Hue = 846;
			Direction = Direction.North;
			CantWalk = true;
		}

		public DaemonStatueN( Serial serial ) : base( serial )
		{
		}
		...
		public void SpawnDaemon( Mobile target )
		{
			...
			BaseCreature daemon = new Daemon();

			daemon.Name = "Stone Daemon";
			daemon.Hue = 846;
			daemon.Direction = Direction.North;
