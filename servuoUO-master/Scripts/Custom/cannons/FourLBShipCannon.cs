...
{
	public class FourLBShipCannon : AddonComponent
	{

		public FourLBShipCannon( int itemID ) : base( itemID )
		{			
			LootType = LootType.Blessed;
		}

		public FourLBShipCannon( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( Addon is FourShipCannonAddon )
			{
				if ( ((FourShipCannonAddon) Addon).IsRewardItem )
					list.Add( 1076223 ); // 7th Year Veteran Reward
					
				list.Add( 1076207, ((FourShipCannonAddon) Addon).Charges.ToString() ); // Remaining Charges: ~1_val~
			}
		}
	...
	public class FourShipCannonAddon : BaseAddon
	{	
		public override BaseAddonDeed Deed
		{
			get
			{
				FourShipCannonDeed deed = new FourShipCannonDeed();
		...
		public FourShipCannonAddon( Serial serial ) : base( serial )
		{
		}
		...
		{
			private FourShipCannonAddon m_Cannon;

			public InternalTarget( FourShipCannonAddon cannon  ) : base( 12, true, TargetFlags.None )
			{
				m_Cannon = cannon;
			}
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump( FourShipCannonAddon cannon, PotionKeg keg ) : base( 50, 50 )
			{
				m_Cannon = cannon;
				m_Keg = keg;
	...
	public class FourShipCannonDeed : BaseAddonDeed, IRewardItem, IRewardOption
	{
		...
		{ 
			get
			{
				FourShipCannonAddon addon = new FourShipCannonAddon( m_Direction );
		...
		[Constructable]
		public FourShipCannonDeed() : base()
		{		
			LootType = LootType.Blessed;
		}

		public FourShipCannonDeed( Serial serial ) : base( serial )
		{
		}
