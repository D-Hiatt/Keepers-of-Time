...
{
	public class FortyEightLBShipCannon : AddonComponent
	{

		public FortyEightLBShipCannon( int itemID ) : base( itemID )
		{			
			LootType = LootType.Blessed;
		}

		public FortyEightLBShipCannon( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( Addon is FortyEightCannonAddon )
			{
				if ( ((FortyEightCannonAddon) Addon).IsRewardItem )
					list.Add( 1076223 ); // 7th Year Veteran Reward
					
				list.Add( 1076207, ((FortyEightCannonAddon) Addon).Charges.ToString() ); // Remaining Charges: ~1_val~
			}
		}
	...
	public class FortyEightCannonAddon : BaseAddon
	{	
		public override BaseAddonDeed Deed
		{
			get
			{
				FortyEightCannonDeed deed = new FortyEightCannonDeed();
		...
		public FortyEightCannonAddon( Serial serial ) : base( serial )
		{
		}
		...
		{
			private FortyEightCannonAddon m_Cannon;

			public InternalTarget( FortyEightCannonAddon cannon  ) : base( 12, true, TargetFlags.None )
			{
				m_Cannon = cannon;
			}
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump( FortyEightCannonAddon cannon, PotionKeg keg ) : base( 50, 50 )
			{
				m_Cannon = cannon;
				m_Keg = keg;
	...
	public class FortyEightCannonDeed : BaseAddonDeed, IRewardItem, IRewardOption
	{
		...
		{ 
			get
			{
				FortyEightCannonAddon addon = new FortyEightCannonAddon( m_Direction );
		...
		[Constructable]
		public FortyEightCannonDeed() : base()
		{		
			LootType = LootType.Blessed;
		}

		public FortyEightCannonDeed( Serial serial ) : base( serial )
		{
		}
