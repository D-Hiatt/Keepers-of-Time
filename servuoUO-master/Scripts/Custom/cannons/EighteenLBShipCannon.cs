...
{
	public class EighteenLBShipCannon : AddonComponent
	{

		public EighteenLBShipCannon( int itemID ) : base( itemID )
		{			
			LootType = LootType.Blessed;
		}

		public EighteenLBShipCannon( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( Addon is EighteenCannonAddon )
			{
				if ( ((EighteenCannonAddon) Addon).IsRewardItem )
					list.Add( 1076223 ); // 7th Year Veteran Reward
					
				list.Add( 1076207, ((EighteenCannonAddon) Addon).Charges.ToString() ); // Remaining Charges: ~1_val~
			}
		}
	...
	public class EighteenCannonAddon : BaseAddon
	{	
		public override BaseAddonDeed Deed
		{
			get
			{
				EighteenCannonDeed deed = new EighteenCannonDeed();
		...
		public EighteenCannonAddon( Serial serial ) : base( serial )
		{
		}
		...
		{
			private EighteenCannonAddon m_Cannon;

			public InternalTarget( EighteenCannonAddon cannon  ) : base( 12, true, TargetFlags.None )
			{
				m_Cannon = cannon;
			}
		...
		private class InternalGump : Gump
		{
			...
			public InternalGump( EighteenCannonAddon cannon, PotionKeg keg ) : base( 50, 50 )
			{
				m_Cannon = cannon;
				m_Keg = keg;
	...
	public class EighteenCannonDeed : BaseAddonDeed, IRewardItem, IRewardOption
	{
		...
		{ 
			get
			{
				EighteenCannonAddon addon = new EighteenCannonAddon( m_Direction );
		...
		[Constructable]
		public EighteenCannonDeed() : base()
		{		
			LootType = LootType.Blessed;
		}

		public EighteenCannonDeed( Serial serial ) : base( serial )
		{
		}
