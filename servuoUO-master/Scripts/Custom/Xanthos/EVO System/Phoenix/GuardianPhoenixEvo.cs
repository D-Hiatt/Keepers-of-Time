...
{
	[CorpseName( "a guardian phoenix corpse" )]
	public class GuardianPhoenix : Phoenix, IEvoGuardian
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

		[Constructable]
		public GuardianPhoenix() : base( "A Guardian Phoenix" )
		{
		}

		public GuardianPhoenix( Serial serial ) : base( serial )
		{
		}
